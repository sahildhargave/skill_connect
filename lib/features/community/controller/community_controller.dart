...
class CommunityController extends StateNotifier<bool> {
  ...
  void editCommunity({
    ...
    state = false;
    res.fold((l) => showSnackbar(context, l.message as Widget),
  ...
  void addMods(
      String communtyName, List<String> uids, BuildContext context) async {
    final res = await _communityRepository.addMods(communtyName, uids);
    res.fold(
